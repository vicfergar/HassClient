...
namespace HassClient.Net.Serialization
{
    /// <summary>
    /// Helper class used by the <see cref="HassWSApi"/> client for serialization.
    /// </summary>
    public static class HassSerializer
    {
        ...
        internal static JsonSerializerSettings DefaultSettings = new JsonSerializerSettings
        {
            ...
            Converters = new List<JsonConverter> { new StringEnumConverter(namingStrategy), new WSMessagesConverter() },
        };
